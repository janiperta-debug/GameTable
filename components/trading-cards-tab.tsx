...
export function TradingCardsTab() {
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="decorative-border">
          <CardHeader>
            <CardTitle className="font-cinzel flex items-center">
              ...
              Trading Cards Management
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              <h4 className="font-semibold text-amber-600 mb-2">Trading Cards Collection</h4>
              <p className="text-sm text-muted-foreground mb-2">Manage your TCG collection and decks.</p>
              <p className="text-xs text-muted-foreground">Manual entry for Magic, Pokemon, Yu-Gi-Oh, and more!</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="decorative-border">
          <CardHeader>
            <CardTitle className="font-cinzel">Add Trading Card Manually</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">Add trading cards/decks to your collection.</p>
            <Button className="w-full bg-amber-600 hover:bg-amber-700">
              <Plus className="h-4 w-4 mr-2" />
              Add Trading Card Manually
            </Button>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="decorative-border">
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="font-cinzel">Your Trading Cards Collection</CardTitle>
          <DropdownMenu>
